    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="flex flex-col items-center text-center space-y-6 flex-1">
                <h2 class="font-medium text-3xl sm:text-4xl leading-tight mb-5">The Director - Message</h2>
                <div class="w-full flex flex-col md:flex-row bg-blue-300">
            ...
            <!-- Principal Section -->
            <div class="flex flex-col items-center text-center space-y-6 flex-1">
                <h2 class="font-medium text-3xl sm:text-4xl leading-tight mb-5">The Principal - Message</h2>
                <div class="w-full flex flex-col md:flex-row bg-pink-300">
