...
<body class="min-h-screen">
    ...
    <section
        class="relative h-auto sm:h-[80vh] flex items-start sm:items-center overflow-hidden px-4 sm:px-8 md:px-20 pt-12 sm:pt-0">
        ...
        <div class="relative z-30 max-w-xl text-center sm:text-left mt-12 sm:mt-0 mb-10 sm:mb-0">
            ...
            <p class="text-base sm:text-lg text-gray-600 leading-relaxed mb-3 sm:mb-4">
                Our playgroup provides a joyful environment where young minds explore, learn, and grow through fun
                activities.
            </p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center">
                ...
                <div class="relative w-[300px]">
                    <img src="{{ asset('images/paper-clips.png') }}" alt="Paper Note"
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-16">
                <span
                    ...
                    Routine</span>
                <h2 class="text-3xl sm:text-5xl font-extrabold text-blue-900 mt-4 mb-4 title-shadow">A Day in Playgroup
                </h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    A balanced mix of play, structured learning, physical activity, and rest designed to support
                    toddlers' natural rhythm.
                </p>
            </div>
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">Warm greetings, morning songs, and light movement
                        to spark energy and connection.</p>
                </div>
                ...
                <div
                    ...
                    <span
                        class="bg-yellow-400 text-blue-950 font-extrabold text-xs px-3 py-1 rounded-full uppercase tracking-wider mt-8 z-10">
                    </span>
                    <h3 class="text-xl font-bold text-blue-900 mt-4 mb-2">Creative Play</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">Sensory explorations, finger painting, and puzzle
                        solving to develop fine motor skills.</p>
                </div>
                ...
                <div
                    ...
                    <span
                        class="bg-blue-600 text-white font-extrabold text-xs px-3 py-1 rounded-full uppercase tracking-wider mt-8 z-10">
                    </span>
                ...
                <div
                    ...
                    <span
                        class="bg-green-500 text-white font-extrabold text-xs px-3 py-1 rounded-full uppercase tracking-wider mt-8 z-10">
                    </span>
                    <h3 class="text-xl font-bold text-blue-900 mt-4 mb-2">Music & Story</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">Puppet shows, nursery rhymes, dance-alongs, and
                        transition to parent pickup.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <p class="text-center text-lg max-w-3xl mx-auto mb-12" style="color: var(--dark);">By the end of our
                playgroup program, your child will develop essential skills across multiple domains</p>
                ...
                <div class="rounded-2xl p-6 shadow-lg" style="background-color: white;">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span style="color: var(--dark);">Follow simple instructions and respond to verbal
                                cues</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle mt-1 mr-3" style="color: var(--secondary);"></i>
    ...
    <section class="py-16 bg-white overflow-hidden">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Sending your child to school for the first time is a milestone. Here is how we partner with you to
                    make it a wonderful start.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        The first few days are about building comfort. We offer a gradual transition period where
                        parents are welcome to support their child as they settle in.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Your toddler gets the care and attention they deserve. Our small ratios ensure a safe,
                        nurturing, and customized learning pace for each child.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Stay connected with your child's day. We share updates on meals, activities, and milestones
                        through our interactive parent portal app.
                    </p>
                </div>
            </div>
        </div>
