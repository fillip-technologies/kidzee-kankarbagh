...
<section class="relative h-auto sm:h-[80vh] flex items-start sm:items-center overflow-hidden px-4 sm:px-8 md:px-20 pt-16 sm:pt-0">
    ...
    <div class="relative z-30 max-w-xl text-center sm:text-left mt-12 sm:mt-0 mb-10 sm:mb-0">
        ...
        <p class="text-base sm:text-lg text-gray-600 leading-relaxed mb-3 sm:mb-4">
            Our kindergarten program fosters early academic skills, creativity, and social-emotional growth in a nurturing environment.
        </p>
        <p class="text-base sm:text-lg text-gray-600 leading-relaxed">
            Children develop language, numeracy, problem-solving, and teamwork abilities while building confidence and independence.
        </p>
    </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center">
            ...
            <div class="relative w-[300px]">
                <img src="{{ asset('images/paper-clips.png') }}" alt="Learning" class="w-full h-auto object-contain">
            ...
            <div class="relative w-[300px]">
                <img src="{{ asset('images/paper-clips.png') }}" alt="Activity" class="w-full h-auto object-contain">
                <ul class="absolute top-[60px] left-[35px] text-blue-900 text-[20px] font-medium leading-[3rem]">
            ...
            <div class="relative w-[300px]">
                ...
                <ul class="absolute top-[60px] left-[35px] text-blue-900 text-[20px] font-medium leading-[3rem]">
                    ...
                    <li>Confidence & Independence</li>
                    <li>Sharing & Cooperation</li>
                </ul>
            </div>

            <div class="relative w-[300px]">
                <img src="{{ asset('images/paper-clips.png') }}" alt="Healthy Habits" class="w-full h-auto object-contain">
                <ul class="absolute top-[60px] left-[35px] text-blue-900 text-[20px] font-medium leading-[3rem]">
...
<section class="py-16 bg-gradient-to-b from-white to-[#fdf4ff] overflow-hidden">
    <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl sm:text-5xl font-extrabold text-blue-900 mt-4 mb-4 title-shadow">A Day in Kindergarten</h2>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                A structured routine that balances classroom academics, interactive laboratories, physical development, and social bonding.
            </p>
        </div>
        ...
        <div class="relative grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="bg-white border-4 border-pink-400 rounded-3xl p-6 shadow-[8px_8px_0px_#ebe1ff] play-card-neobrutal play-card-pink flex flex-col items-center text-center relative mt-4 md:mt-0">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Morning prayer, updates, calendar charting, and reading circle exercises to build language and phonics bases.</p>
            </div>
            ...
            <div class="bg-white border-4 border-yellow-400 rounded-3xl p-6 shadow-[8px_8px_0px_#fefcbd] play-card-neobrutal play-card-yellow flex flex-col items-center text-center relative mt-4 md:mt-0">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Writing routines, logic training, number games, and interactive worksheets customized for school readiness.</p>
            </div>
            ...
            <div class="bg-white border-4 border-blue-400 rounded-3xl p-6 shadow-[8px_8px_0px_#bfdbfe] play-card-neobrutal play-card-blue flex flex-col items-center text-center relative mt-4 md:mt-0">
                ...
                <span class="bg-blue-600 text-white font-extrabold text-xs px-3 py-1 rounded-full uppercase tracking-wider mt-8 z-10">10:45 AM</span>
                <h3 class="text-xl font-bold text-blue-900 mt-4 mb-2">Lunch & Cleanup</h3>
                <p class="text-sm text-gray-600 leading-relaxed">Nutritious meals prepared daily, learning to clean up dining tables, and sorting personal belongings.</p>
            </div>
            ...
            <div class="bg-white border-4 border-green-400 rounded-3xl p-6 shadow-[8px_8px_0px_#d1fae5] play-card-neobrutal play-card-green flex flex-col items-center text-center relative mt-4 md:mt-0">
                ...
                <span class="bg-green-500 text-white font-extrabold text-xs px-3 py-1 rounded-full uppercase tracking-wider mt-8 z-10">11:15 AM</span>
                <h3 class="text-xl font-bold text-blue-900 mt-4 mb-2">Science & Projects</h3>
                <p class="text-sm text-gray-600 leading-relaxed">Simple hands-on experiments, creative craftwork, outdoor peer bonding, and dismissal.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 px-4">
    <div class="max-w-6xl mx-auto">
        ...
        <p class="text-center text-lg max-w-3xl mx-auto mb-12" style="color: var(--dark);">
            By the end of our kindergarten program, children will develop key academic, social, and emotional skills.
        </p>
...
<section class="py-16 bg-white overflow-hidden">
    <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Setting strong foundations requires teamwork. Here is how we prepare kids and support families in Kindergarten.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative bg-pink-50 border-4 border-pink-200 rounded-3xl p-8 hover:bg-[#ebe1ff]/40 transition-all duration-300">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Our academic syllabus is structured to ensure that kids confidently clear admissions for leading primary schools.
                </p>
            </div>
            ...
            <div class="relative bg-yellow-50 border-4 border-yellow-200 rounded-3xl p-8 hover:bg-[#fefcbd]/40 transition-all duration-300">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Sufficient individual guidance allows child development specialists to track writing, basic calculations, and social traits.
                </p>
            </div>
            ...
            <div class="relative bg-blue-50 border-4 border-blue-200 rounded-3xl p-8 hover:bg-[#bfdbfe]/40 transition-all duration-300">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Stay thoroughly updated on academic and developmental milestones through detailed weekly tracking charts sent home.
                </p>
            </div>
        </div>
    </div>
