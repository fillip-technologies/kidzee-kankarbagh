...
@section('content')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="stat-card bg-white rounded-xl shadow p-6 border-l-4 border-primary transition duration-300">
                        <div class="flex justify-between">
                            <div>
                                <p class="text-gray-500">Total Venues</p>
                                <h3 class="text-2xl font-bold text-dark mt-2">86</h3>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl shadow p-6 border-l-4 border-secondary transition duration-300">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-dark mt-2">42</h3>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl shadow p-6 border-l-4 border-purple-500 transition duration-300">
                        <div class="flex justify-between">
                            <div>
                                <p class="text-gray-500">New Vendors</p>
                                <h3 class="text-2xl font-bold text-dark mt-2">24</h3>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl shadow p-6 border-l-4 border-yellow-400 transition duration-300">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-dark mt-2">4.65</h3>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <!-- Recent Bookings -->
                    <div class="bg-white rounded-xl shadow p-6">
                        <h2 class="text-lg font-semibold text-dark mb-6">Recent Bookings</h2>
                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    <tr class="border-b text-sm">
                                        <td class="py-3">Amit Sharma</td>
                                        <td class="py-3">The Grand Ballroom</td>
                                        <td class="py-3">15 Aug, 2025</td>
                                        <td class="py-3">
                                            <span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">Confirmed</span>
                                        </td>
                                    </tr>
                                    <tr class="border-b text-sm">
                                        <td class="py-3">Priya Singh</td>
                                        <td class="py-3">Sunset Resort</td>
                                        <td class="py-3">22 Aug, 2025</td>
                                        <td class="py-3">
                                            <span class="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs">Pending</span>
                                        </td>
                                    </tr>
                                    <tr class="border-b text-sm">
                                        <td class="py-3">Raj Kumar</td>
                                        <td class="py-3">Heritage Banquet</td>
                                        <td class="py-3">5 Sep, 2025</td>
                                        <td class="py-3">
                                            <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">Deposit Paid</span>
                                        </td>
                                    </tr>
                                    <tr class="border-b text-sm">
                                        <td class="py-3">Neha Patel</td>
                                        <td class="py-3">Royal Palace Hotel</td>
                                        <td class="py-3">12 Sep, 2025</td>
                                        <td class="py-3">
                                            <span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">Confirmed</span>
                                        </td>
                                    </tr>
                                    <tr class="text-sm">
                                        <td class="py-3">Vikram Mehta</td>
                                        <td class="py-3">Crystal Gardens</td>
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <div class="space-y-4">
                        <div class="border-b pb-4">
                            ...
                            <p class="text-gray-600 text-sm mt-2">"Excellent venue with spacious halls and professional staff. Highly recommended!"</p>
                        ...
                        <div class="border-b pb-4">
                            ...
                            <p class="text-gray-600 text-sm mt-2">"Beautiful location but the catering could be improved. Overall a good experience."</p>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm mt-2">"The garden setup was perfect for our outdoor wedding. The staff was very accommodating."</p>
